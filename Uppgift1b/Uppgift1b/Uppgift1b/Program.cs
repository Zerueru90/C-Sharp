    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            */
            ...
            Console.WriteLine(i + " Ska vara: 22");
            ...
            Console.WriteLine(i + " Ska vara: 1");
            ...
            Console.WriteLine(sant + " Bör vara: False");
            ...
            Console.WriteLine($"tal1: {tal1}, tal2: {tal2}. Om man multiplicerar båda talen {tal1} * {tal2} = {tal1 * tal2}");
